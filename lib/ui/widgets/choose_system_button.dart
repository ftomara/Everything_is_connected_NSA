...
class ChooseSystemButton extends StatefulWidget {
  const ChooseSystemButton(
      {super.key, required this.onTap, required this.text});
  final Function() onTap;
  final String text;
  @override
  State<ChooseSystemButton> createState() => _CategoryButtonState();
}

class _CategoryButtonState extends State<ChooseSystemButton> {
  late String button;
